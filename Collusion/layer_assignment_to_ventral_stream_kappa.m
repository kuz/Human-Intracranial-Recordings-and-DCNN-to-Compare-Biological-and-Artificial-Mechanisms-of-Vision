...
%% Parameters
mapperset = 'meangamma_bipolar_noscram_artif_17_20_brodmann.actual';
...
for fid = 1:length(listing)
    ...
    for i = 1:nareas
        ...
        % we are interested only if it was mapped to conv layer 1 to 5
    ...
    clearvars -except listing talareich_level featureset area_id_map area_id_map_reverse ...
                      stats areas_of_interest mapperset atlas db labels
