...
% load subject list
listing = dir('../../../Data/Intracranial/Processed/meangamma_onebin/*.mat');
...
for sfile = listing'
    ...
    % load the data
    load(['../../../Data/Intracranial/Processed/meangamma_onebin/' sfile.name]);
    ...
    % store the data
    save(['../../../Data/Intracranial/Processed/meangamma_ventral_onebin/' sfile.name '.mat'], 's');
