...
addpath('/home/kuz/Software/Elan/misc/matlab')

% compose a list of .eeg file
eegfiles = dir('../../Data/Raw_data/*.eeg');
...
for i = 1:length(eegfiles)
    ...
    [m_data, m_events, v_label_selected, s_fs, s_nb_samples_all, s_nb_channel_all, ...
     ...
     eeg2mat(['../../Data/Raw_data/' eegfiles(i).name], 1, 'all', 'all', 'save', ['../../Data/Raw_data/' eegfiles(i).name '.mat']);
